...
\date{June 29, 2010}
% \author[Hagberg]{Aric Hagberg\inst{1} \and Daniel Schult\inst{2} \and Pieter Swart\inst{1}}
% \institute[]{
%   \inst{1}Theoretical Division,\\
%   Los Alamos National Laboratory,
%   Los Alamos, New Mexico 87545, USA
%   \and
%   \inst{2}Department of Mathematics, Colgate University, Hamilton,
%   NY 13346, USA
% }
