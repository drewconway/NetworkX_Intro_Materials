...
% directed graph, pagerank, HITS
% bipartite graphs - make projection, with weights?
% undirected with properties, assortativity by degree or property

% find example data for each
