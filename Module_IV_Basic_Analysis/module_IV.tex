...
\subsection{Visualizing the analysis with \texttt{matplotlib}} % (fold)
\label{sub:visualizing_the_analysis_with_matplotlib}
...
% subsection visualizing_the_analysis_with_matplotlib (end)
