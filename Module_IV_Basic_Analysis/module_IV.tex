...
mode_clus_sg=subgraph(hartford_mc,[(a) for (a,b) in clus.items() if b==clus_counts[0][1]])}}         
    ...
    \begin{columns}
        ...
        \end{itemize}
        \column{.5\textwidth}
            \uncover<5->{\includegraphics[width=4.6cm,clip,trim=1cm 1cm 1cm 1cm]{../images/networks/mode_clus_sg.png}}
    \end{columns}
    \begin{center}
...
\begin{frame}[fragile]
    ...
    \end{itemize}
    \begin{tabular}{ccc}
        \includegraphics[width=3cm]{../images/networks/art1.png} & \includegraphics[width=3cm]{../images/networks/knuth_miles.png} & \includegraphics[width=3cm]{../images/networks/degree_histogram.png}
    \end{tabular}}
\end{frame}
...
P.savefig("../../images/networks/shell.png")}}
            ...
            \end{block}
        \column{.35\textwidth}
            \uncover<5->{\includegraphics[width=4cm,clip,trim=4cm 4cm 4cm 4cm]{../images/networks/shell.png}}
    \end{columns}
    \uncover<-6>{Beyond layout algorithms, however, we may also want to add analytical data to our visualization}
\end{frame}
...
\begin{frame}[plain]
    ...
    \begin{itemize}
        ...
        \uncover<7->{\item Network visualization techniques in NetworkX and how to add network analysis to a visualziation}
    \end{itemize}
