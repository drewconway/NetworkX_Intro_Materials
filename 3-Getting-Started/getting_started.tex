...
\centerline{\includegraphics[width=1.0\columnwidth]{nx-ipython}}
...
\centerline{\includegraphics[width=1.0\columnwidth]{ipython-import}}
\end{frame}

\begin{frame}
\frametitle{The > > > (doctests)}
\centerline{\includegraphics[width=1.0\columnwidth]{python-hello}}
\end{frame}
...
\centerline{\includegraphics[width=1.2\columnwidth]{nx-doc-add}}
\end{frame}

\begin{frame}
\frametitle{What's in NetworkX?}
\centerline{\includegraphics[width=1.2\columnwidth]{nx-doc-add-1}}
\end{frame}

\begin{frame}
\frametitle{What's in Networkx?}
\centerline{\includegraphics[width=1.2\columnwidth]{nx-doc-add-2}}
\end{frame}

\begin{frame}
\frametitle{What's in Networkx?}
\centerline{\includegraphics[width=1.0\columnwidth]{nx-ipython-tab}}
\end{frame}

\begin{frame}
\frametitle{What's in Networkx?}
\centerline{\includegraphics[width=1.0\columnwidth]{nx-ipython-tab-add}}
\end{frame}
